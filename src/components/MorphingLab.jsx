...
export default function MorphingLab({ stepIndex = 0 }) {
  // 100% Homogenous 4-Cardinal Bezier Control Points for all 4 Shapes
  // Cardinal point order: Top -> Right -> Bottom -> Left -> Top
  // This guarantees 100% liquid, buttery-smooth morphing for ALL transitions (including 3 -> 4 & 4 -> 1)!
  const liquidShapes = [
    // 0: Neural AI Core
    {
      name: "NEURAL AI CORE",
    ...
    // 3: Bespoke Villa Residence (Cardinal Point Aligned: Top -> Right Eave -> Bottom Center -> Left Eave -> Top)
    {
      name: "BESPOKE VILLA RESIDENCE",
      path: "M 12,2.5 C 17.5,6.5 20.5,9 20.5,13.5 C 20.5,18.5 16.5,21.5 12,21.5 C 7.5,21.5 3.5,18.5 3.5,13.5 C 3.5,9 6.5,6.5 12,2.5 Z M 12,8 C 14.5,10 15.5,12 15.5,14.5 C 15.5,16.5 14,17.5 12,17.5 C 10,17.5 8.5,16.5 8.5,14.5 C 8.5,12 9.5,10 12,8 Z"
    }
  ];
